...
function ItemList() {
   ...
   const [searchCategory, setSearchCategory] = useState('itemNm') // 검색 카데고리
   ...
   }, [dispatch, page, sellCategory, searchSubmit]) // page, sellCategory, searchSubmit가 바뀔때마다 useEffect가 실행되면서 상품리스트를 다시 불러온다
